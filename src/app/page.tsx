...
export default function Home() {
  return (
    <>
      ...
      <section id="erfaring" className="max-w-3xl mx-auto py-12 px-4">
        <h2 className="text-2xl font-bold mb-4">Erfaring</h2>
        {/* Erfaring-liste */}
      </section>
      <section id="utdanning" className="max-w-3xl mx-auto py-12 px-4">
        <h2 className="text-2xl font-bold mb-4">Utdanning</h2>
        {/* Utdanning-liste */}
      </section>
      <section id="ferdigheter" className="max-w-3xl mx-auto py-12 px-4">
        <h2 className="text-2xl font-bold mb-4">Ferdigheter</h2>
        {/* Ferdigheter-liste */}
      </section>
      <section id="prosjekter" className="max-w-3xl mx-auto py-12 px-4">
        <h2 className="text-2xl font-bold mb-4">Prosjekter</h2>
        {/* Prosjekt-liste */}
      </section>
      <section id="kontakt" className="max-w-3xl mx-auto py-12 px-4">
